...
public class SelectImage1 extends RelativeLayout {
	...
	public SelectImage1(Context context) {
		super(context);
		init(context);
	}

	public SelectImage1(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public SelectImage1(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context) {
		...
		// mHListViewAdapter.setMaxSelectNum(MAX_SELECTED_NUM);
		// mHListViewAdapter.setSelectCallBack(mSelectedCallBack);
		...
		mHListView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						if ((Integer) selectBtn.getTag(0x7f000003) == 0)
							checked = false;
						int index = (Integer) selectBtn.getTag(0x7f000002);

						Log.e("nana", "onItemClick " + position + "   index "
								+ index);
						if (!checked) {
							if (addSelect())
								selectBtn.setTag(0x7f000003, 1);
							selectBtn
									.setImageDrawable(getDrawable(R.drawable.btn_selected));
						} else if (minusSelect()) {
							selectBtn.setTag(0x7f000003, 0);
							selectBtn
