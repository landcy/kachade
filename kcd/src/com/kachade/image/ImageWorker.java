...
/**
 * User: tc Date: 13-7-9 Time: 上午10:03 图片异步加载处理类
 */
@SuppressLint("NewApi")
public class ImageWorker {
	...
	private class LoadBitmapTask extends AsyncTask<Long, Void, BitmapDrawable> {
		...
		/**
		 * 返回与此任务相关的 <code>ImageView</code>， 如果 <code>ImageView</code>
		 * 内的任务是当前任务， 则返回当前 <code>ImageView</code>,否则返回 <code>null</code>。
		 * 
		 * @return
		 */
	 ...
	 * 
	 * @param imageView
	 *            当前存放异步资源图片的<code> ImageView</code>
	 * @return
	 */
